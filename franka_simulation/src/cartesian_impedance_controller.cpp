...
CartesianImpedanceController::CartesianImpedanceController(){
    ...
    tracking_path = "/home/ritagama/kst/Area10NHSim_2"; //cartesian_impedance_controller";
    ...
    file_tracking << " t p_x p_xd p_y p_yd p_z p_zd Ox Oxd Oy Oyd Oz Ozd Ow Owd e_px e_py e_pz e_ox e_oy e_oz\n";
    //file_tracking << " s m m m m m m rad rad rad rad rad rad m m m rad rad rad\n";
    file_tracking << " s m m m m m m rad rad rad rad rad rad rad rad m m m rad rad rad\n";
}
...
void CartesianImpedanceController::update(const ros::Time& /*time*/, const ros::Duration& /*period*/) {
    ...
    file_tracking << " " << TIME << " "
                    ...
                    << orientation.x() << " " << orientation_d_.x() << " "
                    << orientation.y() << " " << orientation_d_.y() << " "
                    << orientation.z() << " " << orientation_d_.z() << " "
                    << orientation.w() << " " << orientation_d_.w() << " "
                    << error[0] << " "
                    << error[1] << " "
                    << error[2] << " "
                    << error[3] << " "
